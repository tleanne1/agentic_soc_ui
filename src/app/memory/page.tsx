          ...
          <div className="p-4 space-y-3">
            <div className="grid gap-3 md:grid-cols-2">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-black/30 border border-white/10 px-3 py-2 text-sm text-slate-100 outline-none"
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full min-h-[110px] rounded-xl bg-black/30 border border-white/10 px-3 py-2 text-sm text-slate-100 outline-none"
                ...
                <div key={m.id} className="p-4 space-y-2">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <button
                      ...
                      className="rounded-xl px-3 py-1.5 text-xs bg-white/10 hover:bg-white/15 border border-white/10"
                    >
                      Delete
                    </button>
                  </div>
                  ...
                  {m.tags?.length ? (
                    <div className="flex flex-wrap gap-2">
                      {m.tags.map((t) => (
                        <span
                          key={t}
                          className="text-[11px] px-2 py-1 rounded-full border border-white/10 bg-black/20 text-slate-300"
                        >
                          {t}
                        </span>
                      ))}
